...
- [General Overview](#general-overview)
  - [Milling](#milling)
  - [Bonding](#bonding)
  - [Needle Press](#needle-press)
- [Evolution of the PMMA Devices](#evolution-of-the-pmma-devices)

<!-- /MarkdownTOC -->

## General Overview

The devices were milled on the CNC and the included g-code files will make producing additional chips very easy. My general process is described below.
...
- Go into `Manual` mode and configure these Hot Press settings:
  +  pressure equal to the surface area of the PMMA device (in inches) times 500 lbs/sq. in
  + 35% pump speed
...
Realizing one of the major drawbacks was beads colliding and coalescing together, especially around the exit port, I designed the chip to exit directly into solution (see video: `RoomTempAgaroseDropletGeneration.mp4` and `FirstDualHeatStage.mp4`). Additionally, the chip was longer to allow the beads to be cooled while still on the PMMA device.
